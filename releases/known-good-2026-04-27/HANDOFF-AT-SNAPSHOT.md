...
>
> **Release artifact:** `releases/known-good-2026-04-27/` (snapshot of `dist/` at this state).
> **Deployment of record:** `https://tiger-claw-marketing-restore-fttdsi305.vercel.app` (aliased to `tigerclaw.io` + `www.tigerclaw.io`).
...
Replaces the prior site ("Tiger Claw | Your AI Follow-Up Assistant")
